...
#    export_png(layout, filename="sankey.png", width=1600, height=1200)
...
def get_national(df):
    ...
    # Aggiungi Colonna Comune di Destinazione (San Donà di Piave)
    g_c['COMUNE DESTINAZIONE'] = 'SAN DONÀ DI PIAVE'

    # Filter
    g_c = g_c[g_c['Flusso']>=200]
...
def get_international(df):
    ...
    # Aggiungi Colonna Comune di Destinazione (San Donà di Piave)
    g_s['COMUNE DESTINAZIONE'] = 'SAN DONÀ DI PIAVE'
    # Filtra solo Flussi >= 50 unità
...
#    datafile = 'data/immigrazione_SanDona.csv'
#    htmlout = 'index.html'
